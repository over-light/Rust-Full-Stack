...
func main() {
	...
	// https://github.com/codahale/hdrhistogram/blob/master/hdr.go#L46
	...
	// https://golang.org/pkg/time/#NewTimer
	runTimeout := time.NewTimer(time.Second * time.Duration(*runtime))

	// https://github.com/briandowns/spinner#prefix-or-append-text-to-the-spinner
	...
	for {
		...
		case <-runTimeout.C:
			...
			// Use type, variable or something here.
